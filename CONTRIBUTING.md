# GfBanao Contributing Guidelines


👋🏼 Welcome, and thank you for your interest in contributing to **GfBanao** — a tech-driven E-learning and Dating platform that helps users build meaningful connections through knowledge, skills, and personal growth.
...
To get started, look at the existing [**create a new issue**](https://github.com/mdazfar2/GfBanao/issues)!
...
**Follow these steps to setup GfBanao on your local machine 👇**
...
```bash
  git clone https://github.com/<your-github-username>/GfBanao.git
```
